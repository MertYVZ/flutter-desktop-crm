...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/meons-logo.svg
  SvgGenImage get meonsLogo => const SvgGenImage('assets/icons/meons-logo.svg');

  /// List of all assets
  List<dynamic> get values => [aGitkeep, logo, meonsLogo];
}
