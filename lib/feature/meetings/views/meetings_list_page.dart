...
import 'package:Ok/feature/meetings/widgets/meetings_filters.dart';
import 'package:Ok/feature/meetings/widgets/meetings_table.dart';
...
final class MeetingsListPage extends StatefulWidget {
...
class _MeetingsListPageState extends BaseState<MeetingsListPage> {
              ...
              child: Column(
                ...
                children: [
                  _PageHeader(
                    ...
                    onCreatePressed: () =>
                        Get.toNamed<void>(AppRoutes.meetingsNew.value),
      ...
      builder: (context, constraints) {
        ...
        final titleSection = Column(
          ...
          children: [
            ...
            const SizedBox(height: AppUiTokens.space8),
            Text(
              'Müşteri görüşmelerini görüntüleyin, arayın ve yönetin.',
