...
class MeetingsFilters extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final searchField = SizedBox(
          ...
          child: TextField(
            ...
            onChanged: (value) {
              ...
              controller.searchAndFilterMeetings();
            },
        ...
        final methodFilter = Obx(
          () => PanelDropdown<MeetingMethod?>(
            label: 'Yöntem',
            hint: 'Yöntem',
            compact: true,
            value: controller.selectedMethodFilter.value,
            items: const [
              null,
            ...
            onChanged: (value) {
              controller.selectedMethodFilter.value = value;
              controller.searchAndFilterMeetings();
            },
          ),
        );

        final subjectFilter = Obx(
          () => PanelDropdown<MeetingSubject?>(
            label: 'Konu',
            hint: 'Konu',
            compact: true,
            value: controller.selectedSubjectFilter.value,
            items: const [
              null,
              ...MeetingSubject.values,
            ],
            itemLabel: (value) {
              if (value == null) {
                return 'Tümü';
            ...
            onChanged: (value) {
              controller.selectedSubjectFilter.value = value;
              controller.searchAndFilterMeetings();
            },
          ),
        );
          ...
          return Column(
            ...
            children: [
              ...
              Wrap(
                ...
                children: [
                  SizedBox(width: _dropdownWidth, child: methodFilter),
                  SizedBox(width: _dropdownWidth, child: subjectFilter),
                  clearButton,
                ],
              ),
              const SizedBox(height: AppUiTokens.space8),
...
class _MeetingDateRangeFilter extends StatelessWidget {
  const _MeetingDateRangeFilter({
