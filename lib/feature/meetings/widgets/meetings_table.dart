  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Obx(() {
        ...
        final deletingId = controller.deletingMeetingId.value;
        ...
        if (records.isEmpty) {
          final message = controller.hasActiveFilters
              ? MeetingMessages.listFilteredEmpty
              : MeetingMessages.listEmpty;
        ...
        final table = DataTable(
          ...
          rows: records
              .map(
                (meeting) => _buildRow(
                  meeting,
                  isDeleting: isDeleting && deletingId == meeting.id,
                ),
              )
              .toList(),
        );
  ...
  DataRow _buildRow(
    ...
    return DataRow(
      cells: [
        ...
        DataCell(
          Text(
            AppDateUtils.formatDate(meeting.date),
            style: _dataStyle,
          ),
        ),
        DataCell(
              ...
              _ActionIconButton(
                ...
                onPressed: isDeleting
                    ...
                    : () async {
                        ...
                        if (deleted) {
                          await controller.searchAndFilterMeetings();
                        }
                      },
              ),
            ],
