...
import 'package:Ok/feature/reminders/widgets/reminders_filters.dart';
import 'package:Ok/feature/reminders/widgets/reminders_table.dart';
...
final class RemindersListPage extends StatefulWidget {
...
class _RemindersListPageState extends BaseState<RemindersListPage> {
              ...
              child: Column(
                ...
                children: [
                  _PageHeader(
                    ...
                    onCreatePressed: () =>
                        Get.toNamed<void>(AppRoutes.remindersNew.value),
      ...
      builder: (context, constraints) {
        ...
        final titleSection = Column(
          ...
          children: [
            ...
            const SizedBox(height: AppUiTokens.space8),
            Text(
              'Periyodik hatırlatmaları görüntüleyin, arayın ve yönetin.',
