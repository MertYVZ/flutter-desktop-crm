...
class NotesFilters extends StatelessWidget {
  ...
  static const _dropdownWidth = 180.0;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final customerFilter = Obx(
          () => PanelDropdown<NoteCustomerFilter?>(
            label: 'Müşteri',
            hint: 'Müşteri',
            compact: true,
            value: controller.selectedCustomerFilter.value,
            items: const [
              null,
              NoteCustomerFilter.general,
              NoteCustomerFilter.linkedToCustomer,
            ],
            itemLabel: (value) {
              if (value == null) {
                return 'Tümü';
            ...
            onChanged: (value) {
              controller.selectedCustomerFilter.value = value;
              controller.searchAndFilterNotes();
            },
          ),
        );
          ...
          return Column(
            ...
            children: [
              ...
              Wrap(
                ...
                children: [
                  SizedBox(width: _dropdownWidth, child: customerFilter),
                  clearButton,
                ],
              ),
              const SizedBox(height: AppUiTokens.space8),
...
class _NotesDateRangeFilter extends StatelessWidget {
  const _NotesDateRangeFilter({
