...
import 'package:Ok/feature/price_offers/widgets/price_offers_filters.dart';
import 'package:Ok/feature/price_offers/widgets/price_offers_table.dart';
...
final class PriceOffersListPage extends StatefulWidget {
  const PriceOffersListPage({super.key});

  @override
  State<PriceOffersListPage> createState() => _PriceOffersListPageState();
}

class _PriceOffersListPageState extends BaseState<PriceOffersListPage> {
              ...
              child: Column(
                ...
                children: [
                  _PageHeader(
                    ...
                    onCreatePressed: () =>
                        Get.toNamed<void>(AppRoutes.priceOffersNew.value),
      ...
      builder: (context, constraints) {
        ...
        final titleSection = Column(
          ...
          children: [
            ...
            const SizedBox(height: AppUiTokens.space8),
            Text(
              'Müşteri fiyat tekliflerini görüntüleyin, arayın ve yönetin.',
