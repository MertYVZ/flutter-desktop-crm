...
final class ExportDetailPage extends StatefulWidget {
  const ExportDetailPage({super.key});

  @override
  State<ExportDetailPage> createState() => _ExportDetailPageState();
}

class _ExportDetailPageState extends BaseState<ExportDetailPage> {
          ...
          return PanelFormScrollView(
            child: Column(
              ...
              children: [
                _PageHeader(
                  title: record.title,
                  subtitle: 'İhracat kayıt detayları',
                ...
                _DetailGroup(
                  ...
                  children: [
                    ...
                    _InfoField(
                      label: 'Müşteri',
                      value: _text(record.customerNameSnapshot),
                    ),
                    _InfoField(
                      label: 'Para birimi',
                      ...
                      children: [
                        _DetailGroup(
                          ...
                          children: [
                            _InfoField(
                              label: 'Ödeme şekli',
                              value: _text(record.paymentMethod),
                            ),
                            _InfoField(
                              label: 'Banka',
                              value: _text(record.bank),
                            ),
                            _InfoField(
                              label: 'İlk ödeme tarihi',
                              value: _date(record.firstPaymentDate),
                            ),
                            _InfoField(
                            ...
                            _InfoField(
                              ...
                              value: _date(record.lastPaymentDate),
                            ),
                            _InfoField(
                        ...
                        _DetailGroup(
                          ...
                          children: [
                            ...
                            _InfoField(
                              ...
                              value:
                                  _amount(record.logisticsCostMinor, currency),
                            ),
                            _InfoField(
                            ...
                            _InfoField(
                              ...
                              value:
                                  _amount(record.insuranceCostMinor, currency),
                            ),
                          ],
                        ),
                        const SizedBox(height: AppUiTokens.space16),
...
class _ExportItemsTable extends StatelessWidget {
  const _ExportItemsTable({
    required this.items,
