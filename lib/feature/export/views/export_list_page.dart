...
import 'package:Ok/feature/export/widgets/export_filters.dart';
import 'package:Ok/feature/export/widgets/export_table.dart';
...
final class ExportListPage extends StatefulWidget {
  const ExportListPage({super.key});

  @override
  State<ExportListPage> createState() => _ExportListPageState();
}

class _ExportListPageState extends BaseState<ExportListPage> {
            ...
            return PanelFormScrollView(
              child: Column(
                ...
                children: [
                  _PageHeader(
                    onCreatePressed: () =>
                        Get.toNamed<void>(AppRoutes.exportsNew.value),
                  ),
      ...
      builder: (context, constraints) {
        ...
        final titleSection = Column(
          ...
          children: [
            ...
            const SizedBox(height: AppUiTokens.space8),
            Text(
              'İhracat kayıtlarını görüntüleyin, arayın ve yönetin.',
