...
class ImportTable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Obx(() {
        final records = controller.imports;
        final isLoading = controller.isLoading.value;
        final isDeleting = controller.isDeleting.value;
        final deletingId = controller.deletingImportId.value;
        ...
        if (records.isEmpty) {
          final message = controller.hasActiveFilters
              ? 'Kriterlere uygun ithalat kaydı bulunamadı.'
              : 'Henüz ithalat kaydı bulunmuyor.';
